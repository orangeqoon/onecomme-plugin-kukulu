...
コメント取得に加え、**お絵描きコメントの画像表示**、OBS等の配信ソフトから接続された際の**自動枠取得**および**自動公開配信（ステータス2化）**にも対応しています。
...
- **お絵描き・画像コメント完全対応**: kukuluLIVE特有の「お絵描きコメント（visualchat）」や画像コメントの画像を直接埋め込んで、わんコメビューアやOBSテンプレート上に画像表示します。
